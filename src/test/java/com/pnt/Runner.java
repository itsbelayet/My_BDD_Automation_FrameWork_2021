...
@CucumberOptions(features = {"src/test/java/com/pnt/features/Login.feature"}, //change accordingly
...
public class Runner {
    ...
    public void generateReport() {
        ...
        String projectName = "Login functionality"; //change accordingly
        ...
        configuration.addClassifications("Username", "Belayet"); //change accordingly
